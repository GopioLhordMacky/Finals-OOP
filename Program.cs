            ...
            while (ProgEnd == 0)
            {
                ...
                switch (response)
                {
                    case 1:
                        ...
                        switch (PasswordChoice)
                        {
                            case 1:
                                ...
                                password = Console.ReadLine();
                                  Console.WriteLine("You have successfully created your username and password!\n");
                               // Console.WriteLine("You have successfully created your username!\n");

                                Console.WriteLine("Login");
                                Console.Write("Enter your username: ");
                                userinput1= Console.ReadLine();
                                Console.Write("Input yout Password: ");
                        ...
                        if (Membership.PremiumLogin( password, username, userinput1, userinput) == 3)
                        {
                            Console.WriteLine($"\nWELCOME {username}, YOUR EXTRAORDINARY EXPERIENCE BEGINS HERE!");
                            int PremiumLoop = 1;
                            while (PremiumLoop > 0)
                            {
